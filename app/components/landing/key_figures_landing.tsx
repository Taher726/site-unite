    ...
    <section className="py-16 px-4 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
        {cards.map((card, index) => (
          ...
          <div key={index} className="bg-gray-50 rounded-xl shadow-md py-10 border border-gray-100 hover:shadow-xl transition duration-300 flex flex-col justify-center items-center" data-aos="fade-up" data-aos-delay={index * 100}>
